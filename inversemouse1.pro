...
UBUNTU_TRANSLATION_DOMAIN="inversemouse1.liu-xiao-guo"
...
aptest.commands = bash $$PWD/inversemouse1/tests/autopilot/run
aptest.depends  = sub-inversemouse1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/inversemouse1/tests/unit
unittest.depends  = sub-inversemouse1
